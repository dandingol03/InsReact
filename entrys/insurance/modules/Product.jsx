                    ...
                    <div >
                            <div className="container" style={{background: 'url(images/background.png) no-repeat',backgroundSize:'100%'}} >
                                <div className="row" style={{marginTop: '20em'}}>
                                    ...
                                    <div className="col-md-6">
                                        <a onClick={this.goToOthers.bind(this,'carInsurance')} className="featured-grid featured-grid-2" style={{border:'#e1e1e1 1px solid',boxShadow:'0px 3px 11px #737373',backgroundImage: 'url(/images/image_2.png)'}}>
                                            <div className="desc">
                                                <h3>车险</h3>
